...
def ensure_model_files():
    ...
    if not os.path.exists(MODEL_PATH):
        try:
            ...
            st.success("Modell erfolgreich heruntergeladen!")
        except Exception as e:
            st.error(f"Modell-Download fehlgeschlagen: {str(e)}")
            return False
    ...
    if not os.path.exists(LABELS_PATH):
        try:
            ...
            st.success("Labels erfolgreich heruntergeladen!")
        except Exception as e:
            st.error(f"Label-Download fehlgeschlagen: {str(e)}")
            return False
